...
LOAD DATA INFILE 'D:/ProgramFiles/MySQL/mysql-8.0.18-winx64/run/cjk-unified-ideographs.txt'
...
LOAD DATA INFILE 'D:/ProgramFiles/MySQL/mysql-8.0.18-winx64/run/s-t.txt'
