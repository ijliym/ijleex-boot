...
LOAD DATA INFILE 'D:/ProgramFiles/MySQL/mysql-8.0.17-winx64/run/cjk-unified-ideographs.txt'
...
LOAD DATA INFILE 'D:/ProgramFiles/MySQL/mysql-8.0.17-winx64/run/s-t.txt'
