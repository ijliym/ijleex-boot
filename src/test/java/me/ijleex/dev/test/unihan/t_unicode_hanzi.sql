...
LOAD DATA INFILE 'D:/ProgramFiles/MySQL/mysql-commercial-8.0.12-winx64/tmp/cjk-unified-ideographs.txt'
...
LOAD DATA INFILE 'D:/ProgramFiles/MySQL/mysql-commercial-8.0.12-winx64/tmp/s-t.txt'
