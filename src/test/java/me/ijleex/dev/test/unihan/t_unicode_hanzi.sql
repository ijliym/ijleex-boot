...
LOAD DATA INFILE 'D:/ProgramFiles/MySQL/mysql-8.0.20-winx64/docs/cjk-unified-ideographs.txt'
...
LOAD DATA INFILE 'D:/ProgramFiles/MySQL/mysql-8.0.20-winx64/docs/s-t.txt'
