...
LOAD DATA INFILE 'D:/ProgramFiles/MySQL/mysql-8.0.18-winx64/run/1.t_ime_dict.txt'
...
INTO OUTFILE 'D:/ProgramFiles/MySQL/mysql-8.0.18-winx64/run/1.t_ime_dict-dd.txt'
FIELDS TERMINATED BY '\t' ENCLOSED BY '' ESCAPED BY '\\'
LINES  STARTING BY '' TERMINATED BY '\n';
...
INTO OUTFILE 'D:/ProgramFiles/MySQL/mysql-8.0.18-winx64/run/1.t_ime_dict-rime.txt'
FIELDS TERMINATED BY '\t' ENCLOSED BY '' ESCAPED BY '\\'
LINES  STARTING BY '' TERMINATED BY '\n';
...
INTO OUTFILE 'D:/ProgramFiles/MySQL/mysql-8.0.18-winx64/run/wb_wwg.txt'
FIELDS TERMINATED BY '\t' ENCLOSED BY '' ESCAPED BY '\\'
LINES  STARTING BY '' TERMINATED BY '\n';
-- ----------------------------------------------------------
...
-- 加载拼音词条
LOAD DATA INFILE 'D:/ProgramFiles/MySQL/mysql-8.0.18-winx64/run/2.t_ime_dict_py.txt'
...
INTO OUTFILE 'D:/ProgramFiles/MySQL/mysql-8.0.18-winx64/run/2.t_ime_dict_py-dd.txt'
FIELDS TERMINATED BY '\t' ENCLOSED BY '' ESCAPED BY '\\'
LINES  STARTING BY '' TERMINATED BY '\n';

-- 导出拼音词条（用于 Rime输入法 2017-09-06 12:45:49）
SELECT code,text,weight FROM t_ime_dict_py ORDER BY code,weight DESC
INTO OUTFILE 'D:/ProgramFiles/MySQL/mysql-8.0.18-winx64/run/2.t_ime_dict_py-rime.txt'
FIELDS TERMINATED BY '\t' ENCLOSED BY '' ESCAPED BY '\\'
LINES  STARTING BY '' TERMINATED BY '\n';
...
INTO OUTFILE 'D:/ProgramFiles/MySQL/mysql-8.0.18-winx64/run/01.五笔-主码-常用字.txt'
FIELDS TERMINATED BY '\t' ENCLOSED BY '' ESCAPED BY '\\'
LINES  STARTING BY '' TERMINATED BY '\n';

SELECT text,code,weight FROM t_ime_dict
WHERE type='-#类1'
INTO OUTFILE 'D:/ProgramFiles/MySQL/mysql-8.0.18-winx64/run/02.五笔-主码-词组.txt'
FIELDS TERMINATED BY '\t' ENCLOSED BY '' ESCAPED BY '\\'
LINES  STARTING BY '' TERMINATED BY '\n';

-- 导出拼音词库
SELECT text,code,weight FROM t_ime_dict_py
INTO OUTFILE 'D:/ProgramFiles/MySQL/mysql-8.0.18-winx64/run/07.五笔-辅码-拼音.txt'
FIELDS TERMINATED BY '\t' ENCLOSED BY '' ESCAPED BY '\\'
LINES  STARTING BY '' TERMINATED BY '\n';
