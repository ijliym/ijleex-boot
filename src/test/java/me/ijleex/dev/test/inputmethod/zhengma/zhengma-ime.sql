...
LOAD DATA INFILE 'D:/ProgramFiles/MySQL/mysql-8.0.19-winx64/docs/1.t_ime_dict-zm.txt'
...
INTO OUTFILE 'D:/ProgramFiles/MySQL/mysql-8.0.19-winx64/docs/1.t_ime_dict-zm-dd.txt'
FIELDS TERMINATED BY '\t' ENCLOSED BY '' ESCAPED BY '\\'
LINES  STARTING BY '' TERMINATED BY '\n';
...
INTO OUTFILE 'D:/ProgramFiles/MySQL/mysql-8.0.19-winx64/docs/1.t_ime_dict-zm-rime.txt'
FIELDS TERMINATED BY '\t' ENCLOSED BY '' ESCAPED BY '\\'
LINES  STARTING BY '' TERMINATED BY '\n';
