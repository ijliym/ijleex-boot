...
INTO OUTFILE 'D:/ProgramFiles/MySQL/mysql-commercial-8.0.12-winx64/tmp/count-out.txt'
...
GROUP BY letter
ORDER BY letter
INTO OUTFILE 'D:/ProgramFiles/MySQL/mysql-commercial-8.0.12-winx64/tmp/dict-out.txt'
FIELDS TERMINATED BY '\t' ENCLOSED BY '' ESCAPED BY '\\'
LINES  STARTING BY '' TERMINATED BY '\n';
